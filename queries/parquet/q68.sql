...
from
  ...
  where
    ...
    and store_sales_parquet.ss_addr_sk = customer_address_parquet.ca_address_sk
    -- and date_dim_parquet.d_dom between 1 and 2
    and (household_demographics_parquet.hd_dep_count = 5
      or household_demographics_parquet.hd_vehicle_count = 3)
    -- and date_dim_parquet.d_year in (1999, 1999 + 1, 1999 + 2)
    and store_parquet.s_city in ('Midway', 'Fairview')
  ...
  customer_parquet,
  customer_address_parquet current_addr
where
  ss_customer_sk = c_customer_sk
  and customer_parquet.c_current_addr_sk = current_addr.ca_address_sk
