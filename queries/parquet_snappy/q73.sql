...
from
  ...
  where
    ...
    and case when household_demographics_parquet_snappy.hd_vehicle_count > 0 then household_demographics_parquet_snappy.hd_dep_count / household_demographics_parquet_snappy.hd_vehicle_count else null end > 1
    -- and date_dim_parquet_snappy.d_year in (1998, 1998 + 1, 1998 + 2)
    and store_parquet_snappy.s_county in ('Saginaw County', 'Sumner County', 'Appanoose County', 'Daviess County')
